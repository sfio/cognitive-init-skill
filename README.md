...
**gh skill(推奨)** — [GitHub CLI v2.90.0 以降](https://cli.github.com/) が必要:

```bash
# プロジェクトに配置
gh skill install sfio/cognitive-init cognitive-init --agent claude-code

# または個人のグローバル設定に配置
gh skill install sfio/cognitive-init cognitive-init --agent claude-code --scope user
```
...
cp -r cognitive-init/skills/cognitive-init <your-project>/.claude/skills/

# または個人のグローバル設定に配置
cp -r cognitive-init/skills/cognitive-init ~/.claude/skills/
```
